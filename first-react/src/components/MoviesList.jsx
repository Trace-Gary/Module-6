...
//     // return (
//     //     <div className="MoviesList componenetBox">
//     //         <ul>{ MovieItems }</ul>
//     //     </div>
//     // )
...
//         <div className="MoviesList componentBox">
//             <ul>{ movieItems }</ul>
//             <button onClick={handleReverseMovies}>ReverseList</button>
//             <button onClick={ () => handleDeleteMovie(2)}>Delete Movie with ID of 2</button>
//         </div>
//     )
...
//below is the code luis gave us. some parts the same as above
